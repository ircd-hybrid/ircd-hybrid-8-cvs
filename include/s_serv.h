 ...
 *  s_serv.h: The server functions header.
 *
 ...
 *  USA
 *
 *   $Id: s_serv.h,v 1.3 2002/04/26 04:00:24 a1kmm Exp $
 */
...
extern void ll_burst_channel(struct Client *client_p, struct Channel *chptr);
