 ...
 *  USA
 *
 *   $Id: m_die.c,v 1.4 2002/01/13 07:15:34 a1kmm Exp $
 */
...
struct Message die_msgtab[] = {
  {"DIE", 0, 0, 1, 0, MFLG_SLOW, 0, &p_unregistered, &m_unregistered},
  {"DIE", 0, 0, 1, 0, MFLG_SLOW, 0, &p_user, &m_not_oper},
  {"DIE", 0, 0, 1, 0, MFLG_SLOW, 0, &p_operuser, &mo_die},
