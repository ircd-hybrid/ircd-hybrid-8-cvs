 ...
 *  USA
 *
 *   $Id: m_mode.c,v 1.4 2002/01/13 07:15:34 a1kmm Exp $
 */
...
struct Message mode_msgtab[] = {
  {"MODE", 0, 0, 2, 0, MFLG_SLOW, 0, &p_unregistered, &m_unregistered},
  {"MODE", 0, 0, 2, 0, MFLG_SLOW, 0, &p_user, &m_mode},
#ifdef ENABLE_TS5
  {"MODE", 0, 0, 2, 0, MFLG_SLOW, 0, &p_ts5, &m_mode},
#endif
