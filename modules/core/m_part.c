 ...
 *  USA
 *
 *   $Id: m_part.c,v 1.4 2002/01/13 07:15:34 a1kmm Exp $
 */
...
struct Message part_msgtab[] = {
  {"PART", 0, 0, 2, 0, MFLG_SLOW, 0, &p_unregistered, &m_unregistered},
  {"PART", 0, 0, 2, 0, MFLG_SLOW, 0, &p_user, &m_part},
#ifdef ENABLE_TS5
  {"PART", 0, 0, 2, 0, MFLG_SLOW, 0, &p_ts5, &m_part},
#endif
