 ...
 *  USA
 *
 *   $Id: m_squit.c,v 1.4 2002/01/13 07:15:34 a1kmm Exp $
 */
...
struct Message squit_msgtab[] = {
  {"SQUIT", 0, 0, 1, 0, MFLG_SLOW, 0, &p_unregistered, &m_unregistered},
  {"SQUIT", 0, 0, 1, 0, MFLG_SLOW, 0, &p_user, &m_not_oper},
  {"SQUIT", 0, 0, 1, 0, MFLG_SLOW, 0, &p_operuser, &mo_squit},
#ifdef ENABLE_TS5
  {"SQUIT", 0, 0, 1, 0, MFLG_SLOW, 0, &p_ts5, &ms_squit},
#endif
