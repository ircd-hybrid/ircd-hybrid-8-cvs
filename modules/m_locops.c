 ...
 *  USA
 *
 *   $Id: m_locops.c,v 1.4 2002/01/13 07:15:18 a1kmm Exp $
 */
...
struct Message locops_msgtab[] = {
  {"LOCOPS", 0, 0, 2, 0, MFLG_SLOW, 0, &p_unregistered, &m_unregistered},
  {"LOCOPS", 0, 0, 2, 0, MFLG_SLOW, 0, &p_user, &m_not_oper},
  {"LOCOPS", 0, 0, 2, 0, MFLG_SLOW, 0, &p_operuser, &m_locops},
