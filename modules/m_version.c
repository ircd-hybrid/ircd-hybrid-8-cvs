 ...
 *  USA
 *
 *   $Id: m_version.c,v 1.4 2002/01/13 07:15:20 a1kmm Exp $
 */
...
struct Message version_msgtab[] = {
  {"VERSION", 0, 0, 0, 0, MFLG_SLOW, 0, &p_unregistered, &m_unregistered},
  {"VERSION", 0, 0, 0, 0, MFLG_SLOW, 0, &p_user, &m_version},
  {"VERSION", 0, 0, 0, 0, MFLG_SLOW, 0, &p_operuser, &mo_version},
#ifdef ENABLE_TS5
  {"VERSION", 0, 0, 0, 0, MFLG_SLOW, 0, &p_ts5, &ms_version},
#endif
